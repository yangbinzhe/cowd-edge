...
export function buildCapabilitySpecs(): Record<CapabilityId, CapabilitySpec> {
  ...
  memory: spec(
    ...
    [
      ...
      section('context-envelope', t('memory.contextEnvelope.label'), t('memory.contextEnvelope.raw'), 'summary', 'compact', 'memory.context-envelope'),
      section('knowledge-governance', t('memory.knowledgeGovernance.label'), t('memory.knowledgeGovernance.raw'), 'governance', 'inspect', 'memory.knowledge-governance'),
    ...
    [
      ...
      { label: t('memory.contextEnvelope.label'), kind: 'secondary', endpoint: '/api/memory/context-envelope' },
      { label: t('memory.knowledgeGovernance.label'), kind: 'secondary', endpoint: '/api/memory/knowledge' },
